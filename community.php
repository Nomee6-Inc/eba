...
$getuserrole = $dataquery['role'];
    ...
    header("Location: index.php?redir=community.php");
}
?>
...
<html lang="tr">
  <head>
    ...
    <title>Topluluk | Escort Buluşma Ağı</title>
    <!-- CSS files -->
    ...
    <meta property="og:title" content="Nomee6 Eitim" />
        ...
        <div class="list-group list-group-flush list-group-hoverable">
           <?php
             ...
             while($row = mysqli_fetch_array($result)){
               $getpostowneruserid = $row['user'];
               $getpostcontent = $row['post'];
               $getpostdate = $row['date'];
               	$getpostuquery = mysqli_query($conn, "SELECT * FROM users WHERE userid = '$getpostowneruserid'");
				$getposturesult = $getpostuquery->fetch_assoc();
				$getpostuavatar = $getposturesult['avatar'];
               $getpostusername = $getposturesult['username'];
                echo "<div class=\"list-group-item\">
                      <div class=\"row align-items-center\">
                        <div class=\"col-auto\">
                          <a href=\"profile.php?profileid=$getpostusername\">
                            <span class=\"avatar\" style=\"background-image: url(./avatars/$getpostuavatar)\"></span>
                          </a>
                        </div>
                        <div class=\"col text-truncate\">
                          <a href=\"profile.php?profileid=$getpostusername\" class=\"text-body d-block\">$getpostusername</a>
                          <small class=\"d-block text-blue text-truncate mt-n1\">$getpostcontent</small>
                          <small class=\"d-block text-muted text-truncate mt-n1\">$getpostdate</small>
                        </div>
                      </div>
                    </div>";
             };
