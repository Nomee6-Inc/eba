                ...
                $(document).ready(function () {
                    $.getJSON(\"./posts.json\", 
                        ...
                        $.each(data, function (key, value) {
                            student += '<div class=\"page-body\">'
                            student += '<div class=\"container-xl\">'
                            student += '<div class=\"row justify-content-center\">'
                            student += '<div class=\"card\">'
                            student += '<div class=\"divide-y\">'
                            student += '<div>'
                            student += '<div class=\"row\">';
                            student += '<div class=\"col-auto\">';
                            student += '<span class=\"avatar\" style=\"background-image: url(./avatars/'+value.name+'.png)\"></span>'
                            student += '</div>'
                            student += '<div class=\"text-truncate\">'
                            student += '<a href=\"profile.php?profileid='+value.name+'\"><strong>'+value.name+': </strong></a>'+value.post
                            student += '</div>'
