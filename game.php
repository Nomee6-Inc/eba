...
<html lang="tr">
  <head>
    ...
    <title>Oyun | Escort Buluşma Ağı</title>
    <!-- CSS files -->
    ...
    <meta property="og:description" content="Daha iyi bir eğitim NOMEE6 Eğitim ile mümkün! Sadece 3 ders ile tüm nesili geleceğe çok iyi hazrlyoruz." />
  ...
  <body>
    <div class="wrapper">
      ...
      <div class="page-wrapper">
        ...
        <div class="container-xl">
            <div id="games" class="row row-cards">
            <script>
                $(document).ready(function () {
                    $.getJSON("./games.json", 
                        ...
                        $.each(data, function (key, value) {
                            ...
                            student += '<a href="games/'+value.gameid+'" class="d-block"><img src="assets/'+value.thumbnail+'" class="card-img-top"></a>'
