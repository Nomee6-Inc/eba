...
$getuserrole = $dataquery['role'];
    ...
    header("Location: index.php?redir=tests.php");
}
?>
...
<html lang="tr">
  <head>
    ...
    <title>Testler | Escort Buluşma Ağı</title>
    <!-- CSS files -->
  ...
  <body>
    <div class="wrapper">
      ...
      <div class="page-wrapper">
        ...
        <div class="container-xl">
            <div id="tests" class="row row-cards">
            <script>
                $(document).ready(function () {
                    $.getJSON("./tests.json", 
                        ...
                        $.each(data, function (key, value) {
                            ...
                            student += '<a href="tests/'+value.testid+'" class="d-block"><img src="assets/'+value.thumbnail+'" class="card-img-top"></a>'
