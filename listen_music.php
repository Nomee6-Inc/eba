...
$getmusicid = htmlentities($_GET["musicid"]);
} else {
    header("Location: index.php?redir=listen_music.php?musicid$getmusicid");
}
?>
...
<audio controls>
  <source src="musics/<?php echo $getmusicid; ?>.mp3" type="audio/mpeg">
</audio>
