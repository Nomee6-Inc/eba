            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <div class="d-none d-xl-block ps-2">
                  ...
                  <div class="mt-1 small text-muted">Öğrenci</div>
                </div>
      ...
      <div class="page-wrapper">
        <div class="container-xl">
          <div class="page-header d-print-none">
            ...
            <div class="container-xl">
                <div><h4></h4></div>
                <a href="new_comment.php?videoid=<?php echo $getvideoid; ?>" class="btn btn-primary d-none d-sm-inline-block">
            ...
            <script>
                $(document).ready(function () {
                    $.getJSON(\"/comments/$getvideoid.json\", 
                        function (data) {
                        var student = '';
                        $.each(data, function (key, value) {
                            ...
                            student += '<div>'
                            student += '<span class=\"avatar\" style=\"background-image: url(./avatars/'+value.userid+'.png)\"></span>'
                            student += '<a href=\"profile.php?profileid='+value.userid+'\">'+value.userid+'</a>';
                            student += '<div>'+'<h3>Yorum: '+value.comment+'<h3>'+'</div>';
                            student += '<div>'+value.date+'</div>';
                            student += '</div>'
                            student += '</div>'
                            student += '</div>'
                            student += '</div>'
