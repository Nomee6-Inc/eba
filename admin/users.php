                ...
                $(document).ready(function () {
                    $.getJSON("../userdata.json", 
                        ...
                        $.each(data, function (key, value) {
                            student += '<tr>';
                            student += '<td></td>';
                            student += '<td><a href=\"../profile.php?profileid='+value.id+'\" class=\"text-reset\" tabindex=\"-1\">'+value.id+'</a></td>';
                            student += '<td>';
                            student += '<span class=\"badge bg-'+value.rolecolor+'-lt\">'+value.role+'</span>';
                            student += '</td>';
                            student += '<td><span class=\"text-muted\">'+value.not+'</span></td>';
                            student += '<td>';
                            student += '<span class=\"dropdown\">';
                            student += '<button class=\"btn dropdown-toggle align-text-top\" data-bs-boundary=\"viewport\" data-bs-toggle=\"dropdown\">Eylemler</button>';
                            student += '<div class=\"dropdown-menu dropdown-menu-end\">';
                            student += '<a class=\"dropdown-item\" href=\"update_note.php?userid='+value.id+'\">';
                            student += 'Üyenin Notunu Güncelle';
                            student += '</a>';
                            student += '<a class=\"dropdown-item\" href=\"update_roles.php?userid='+value.id+'\">';
                            student += 'Üyenin Yetkisini Güncelle';
                            student += '</a>';
                            student += '</div>';
                            student += '</span>';
                            student += '</td>';
