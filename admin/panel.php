...
$jsonuserdata = file_get_contents("../userdata.json");
$userdata_array = json_decode($jsonuserdata);
$jsonvideos = file_get_contents("../videos.json");
$videos_array = json_decode($jsonvideos);
$jsondocs = file_get_contents("../docs.json");
$docs_array = json_decode($jsondocs);
$jsongame = file_get_contents("../games.json");
$games_array = json_decode($jsongame);
$jsonmusic = file_get_contents("../musics.json");
$music_array = json_decode($jsonmusic);
$jsontests = file_get_contents("../tests.json");
$tests_array = json_decode($jsontests);
$totalcontent = count($videos_array) + count($docs_array) + count($games_array) + count($music_array) + count($tests_array);
?>
...
<html lang="tr">
  ...
  <body>
        ...
        <div class="card-body">
                    ...
                    <div class="row g-2 align-items-center mb-n3">
                      <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                        <a href="upload_video.php" class="btn btn-primary btn-pill w-100">
                          Video Yükle
                        </a>
                      </div>
                      <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                        <a href="upload_music.php" class="btn btn-warning btn-pill w-100">
                          Müzik Yükle
                        </a>
                      </div>
                      <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                        <a href="upload_doc.php" class="btn btn-light btn-pill w-100">
                          Döküman Yükle
                        </a>
                      </div>
                      <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                        <a href="users.php" class="btn btn-secondary btn-pill w-100">
                          Üyeleri Yönet
                        </a>
                      </div>
                    </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Toplam Üye Sayısı</div>
                      <div class="ms-auto lh-1">
                      </div>
                    </div>
                    <div class="h1 mb-3"><?php echo count($userdata_array); ?> Üye</div>
                  </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-baseline">
                      <div class="h1 mb-0 me-2"><?php echo $totalcontent; ?></div>
                      <div class="me-auto">
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Son 1 Haftada Kayıt Olan Sayısı</div>
                      <div class="ms-auto lh-1">
                      </div>
                    </div>
                    <div class="d-flex align-items-baseline">
                      <div class="h1 mb-0 me-2"><?php echo $lastweekregistereduser; ?></div>
                      <div class="me-auto">
                    </div>
                </div>
            </div>
    ...
    <!-- Libs JS -->
    <script src="https://egitim.nomee6.xyz/dist/libs/apexcharts/dist/apexcharts.min.js"></script>
    <!-- Tabler Core -->
