...
if($getuserrole == "Yönetici") {
	$analyticsqueryu = $db->query("SELECT * FROM users",PDO::FETCH_ASSOC);
	$usercount = $analyticsqueryu -> rowCount();
  
  	$analyticsqueryc = $db->query("SELECT * FROM contents",PDO::FETCH_ASSOC);
	$contentcount = $analyticsqueryc -> rowCount();
} else {
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <div class="d-none d-xl-block ps-2">
                  ...
                  <div class="mt-1 small text-muted"><?php $getuserrole; ?></div>
                </div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="h1 mb-3"><?php echo $usercount; ?> Üye</div>
                  </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-baseline">
                      <div class="h1 mb-0 me-2"><?php echo $contentcount; ?></div>
                      <div class="me-auto">
                      </div>
                    </div>
                  </div>
