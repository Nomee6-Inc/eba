...
if($getuserid == "" || $getuserid == "aliyasin") {
  ...
  if (isset($_POST['submit'])) {
	$getnewnote = htmlentities($_POST['newnote']);
...
<html lang="tr">
  <head>
    ...
    <meta property="og:description" content="Daha iyi bir eğitim NOMEE6 Eğitim ile mümkn! Sadece 3 ders ile tm nesili geleceğe çok iyi hazırlıyoruz." />
	<?php
	echo("
	<!-- Matomo -->
	  <script>
							...
							<div class="col-xl-4">
				            	<div class="row">
									<div class="col-md-6 col-xl-12">
										<div class="mb-3">
				                		<label class="form-label"><?php echo $getuserid; ?> kullanıcısının Yeni Notu:</label>
				                		<input type="number" class="form-control" placeholder="Yeni not" name="newnote" max="100" required>
				            		</div>
									<div class="input-group">
										<button name="submit" class="btn">Güncelle</button>
									</div>
									<small class="form-hint">
				                        Not: 100'den fazla girmeyiniz.
				                    </small>
								    </div>
							    </div>
						    </div>
