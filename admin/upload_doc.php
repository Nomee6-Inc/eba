...
if(isset($_POST["submit"])) {
  $getdocname = htmlentities($_POST['docname']);
  ...
  $getthumbnailname = basename($_FILES["thumbnail"]["name"]);
	...
	if (move_uploaded_file($_FILES['docupload']['tmp_name'], $uploadfile) && move_uploaded_file($_FILES['thumbnail']['tmp_name'], $uploadfilet)) {
		...
		$save_content_insert = $insertcontent->execute(array(
		     "doc", $md5docname, $getdocname, " ", $getthumbnailname
		));
    ...
    header("Location: index.php?redir=admin/upload_doc.php");
}
?>
...
<html lang="tr">
  <head>
    ...
    <meta property="og:description" content="Daha iyi bir eğitim NOMEE6 Eğitim ile mümkün! Sadece 3 ders ile tm nesili geleceğe çok iyi hazırlyoruz." />
	<?php
	echo("
	<!-- Matomo -->
	  <script>
							...
							<div class="col-xl-4">
				            	<div class="row">
									<div class="col-md-6 col-xl-12">
										<div class="mb-3">
                                            <input type="text" placeholder="Dökman İsmi" name="docname" id="docname" class="form-control" required>
                                        </div>
                                        <div class="mb-3">
