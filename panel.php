...
include 'api/NotificationHandler.php';
...
$getuserlooklater = $dataquery['look_later'];

$getuserlooklaterarray = explode(",", $getuserlooklater);
  
if(isset($_POST['look_later_delete'])) {
$getdeletecontentid = $_POST['look_later_delete'];
  
if(strstr($getuserlooklater, ",$getdeletecontentid")) {
      $new_look_later_list = str_replace(",$getdeletecontentid", "", $getuserlooklater);
} else if(strstr($getuserlooklater, "$getdeletecontentid,")) {
      $new_look_later_list = str_replace("$getdeletecontentid,", "", $getuserlooklater);
} else {
      $new_look_later_list = str_replace("$getdeletecontentid", "", $getuserlooklater);
}
...
look_later = :new_look_later
WHERE userid = :userid");
$look_later_list_update = $query->execute(array(
     "new_look_later" => "$new_look_later_list",
     "userid" => "$get_user_unique_id"
));

if($look_later_list_update) {
	header("Refresh:1");
} else {
...
<html lang="tr">
  <head>
    ...
    <meta property="og:description" content="Daha iyi bir eğitim NOMEE6 Eğitim ile mümkün! Sadece 3 ders ile tüm nesili geleceğe çok iyi hazrlıyoruz." />
	<?php
	echo("
	<!-- Matomo -->
	  <script>
      ...
      <header class="navbar navbar-expand-md navbar-light d-print-none">
        <div class="container-xl">
          ...
          <div class="navbar-nav flex-row order-md-last">
            ...
            <a href="?theme=dark" class="nav-link px-0 hide-theme-dark" title="Koyu Temayı Etkinletir" data-bs-toggle="tooltip" data-bs-placement="bottom">
                ...
                <div class="card-body">
                    <div class="row g-2 align-items-center mb-n3">
                      <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                        <a href="videos.php" class="btn btn-primary btn-pill w-100">
                          Video İçerik
                        </a>
                      </div>
                      <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                        <a href="tests.php" class="btn btn-warning btn-pill w-100">
                          Testler
                        </a>
                      </div>
                      <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                        <a href="game.php" class="btn btn-light btn-pill w-100">
                          Oyun
                        </a>
                      </div>
                      <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                        <a href="docs.php" class="btn btn-secondary btn-pill w-100">
                          Dökümanlar
                        </a>
                      </div>
                      <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                        <a href="community.php" class="btn btn-success btn-pill w-100">
                          Topluluk
                        </a>
                      </div>
                    </div>
          ...
          <div class="col-md-6">
                <div class="card mb-3">
                  <div class="card-header">
                    <h3 class="card-title">Daha sonra bakacaklarım</h3>
                  </div>
                  <form action="" method="POST">
                  <div class="list-group list-group-flush list-group-hoverable">
                    <?php
                    if($getuserlooklater != "") {
                    	foreach($getuserlooklaterarray as $array) {
                          $query87 = mysqli_query($conn,"SELECT * FROM contents WHERE contentid = '$array'");
						  $result87 = $query87->fetch_assoc();
                          $getcontentname = $result87['name'];
                          $getcontenttype = $result87['type'];
                          $getcontentthumbnail = $result87['thumbnail'];
                          
                          if($getcontenttype == "doc") {
                          	$getcontenturl = "view_doc.php?docid=$array";
                          } else if($getcontenttype == "music") {
                          	$getcontenturl = "listen_music.php?musicid=$array";
                          } else if($getcontenttype == "video") {
                          	$getcontenturl = "view_video.php?videoid=$array";
                          }
                      ...
                      <div class="row align-items-center">
                        <div class="col-auto">
                          <a href="#">
                            <span class="avatar" style="background-image: url(assets/'.$getcontentthumbnail.')"></span>
                          </a>
                        </div>
                        <div class="col text-truncate">
                          <a href="'.$getcontenturl.'" class="text-body d-block">'.$getcontentname.'</a>
                        </div>
                        <div class="col-auto">
                          <button name="look_later_delete" value="'.$array.'" class="btn">
