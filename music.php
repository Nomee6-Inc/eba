  ...
  <body>
    <div class="wrapper">
      ...
      <div class="page-wrapper">
        ...
        <div class="container-xl">
            <div id="musics" class="row row-cards">
            <script>
                $(document).ready(function () {
                    $.getJSON("./musics.json", 
                        ...
                        $.each(data, function (key, value) {
                            ...
                            student += '<a href="listen_music.php?musicid='+value.musicid+'" class="d-block"><img src="assets/'+value.thumbnail+'" class="card-img-top"></a>'
