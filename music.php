...
$getuserrole = $dataquery['role'];
    ...
    header("Location: index.php?redir=music.php");
}
?>
...
<html lang="tr">
  <head>
    ...
    <title>Müzik | Escort Buluşma Ağı</title>
    <!-- CSS files -->
        ...
        <div class="container-xl">
          <div class="page-header d-print-none">
            ...
            <div class="row row-cards">
              <?php
             $sql = "SELECT * FROM contents WHERE type = 'music'";
               ...
               $getcontentname = $row['name'];
                ...
                <div class=\"col-sm-6 col-lg-4\">
                	<div class=\"card card-sm\">
                    	<a href=\"listen_music.php?musicid=$getcontentid\" class=\"d-block\"><img src=\"assets/$getcontentthumbnail\" class=\"card-img-top\"></a>
                        	<div class=\"card-body\">
