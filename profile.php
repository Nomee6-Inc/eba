...
if($_GET['profileid']) {
	$getprofilid = htmlentities($_GET['profileid']);
} else {
	$getprofilid = $getusername;
}
//
  
$getprofilequery = $db->query("SELECT * FROM users WHERE username = '{$getprofilid}'",PDO::FETCH_ASSOC);
$getprofiledataquery = $getprofilequery->fetch(PDO::FETCH_ASSOC);
$getprofileuname = $getprofiledataquery['username'];
$getprofileavatar = $getprofiledataquery['avatar'];
$getprofilerole = $getprofiledataquery['role'];
$getprofilerolecolor = $getprofiledataquery['rolecolor'];
$getprofileabout = $getprofiledataquery['about'];
$getprofilenote = $getprofiledataquery['note'];
  
} else {
    header("Location: index.php?redir=profile.php");
}
?>
...
<html lang="tr">
  <head>
    ...
    <title><?php echo $getprofilid; ?> | Escort Buluşma Ağı</title>
    <!-- CSS files -->
  ...
  <body>
    <div class="wrapper">
      ...
      <div class="page-wrapper">
        ...
        <div class="page-body">
            <div class="container-xl">
                <span class="avatar avatar-xl mb-3 avatar-rounded" style="background-image: url(./avatars/<?php echo $getprofileavatar; ?>)"></span>
                <h3 class="m-0 mb-1"><?php echo $getprofilid; ?></h3>
                <span class="badge bg-<?php echo $getprofilerolecolor; ?>-lt"><?php echo $getprofilerole; ?></span>
                <div class="card-body">
                  </div>
            </div>
        </div>
        <?php 
        if($getusername == $getprofilid) {
            echo "<div class=\"col-6 col-sm-4 col-md-2 col-xl-auto mb-3\">
                        <a href=\"account.php\" class=\"btn btn-tabler w-100\">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p><?php echo $getprofileabout; ?></p>
                    <h3 class="card-title">Kullanıcı Not Ortalaması</h3>
                    <p><?php echo $getprofilenote; ?></p>
                    <p><?php 
                    if($getprofilenote < 50) {
                        echo "Sınıfta Kaldı";
                    } else if($getprofilenote > 50) {
                        echo "Sınıfı Geçti! Böyle Devam";
                    }
                    ?></p>
                  </div>
              </div>
