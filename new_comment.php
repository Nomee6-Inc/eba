...
if (isset($_POST['submit'])) {
    function fileWriteAppend(){
		$current_data = file_get_contents('./comments/'.$_GET["videoid"].'.json');
...
if(file_exists("comments/$getvideoid.json"))
{
     $final_data=fileWriteAppend();
     if(file_put_contents("comments/$getvideoid.json", $final_data))
     {
          $message = "success";
     }
};
    ...
    <div class="wrapper">
      ...
      <div class="page-wrapper">
        ...
        <form action="" method="POST">
			<div class="mb-3">
				<input class="form-control" rows="6" type="text" placeholder="Yorum İçeriği" name="comment" required>
            </div>
			<div class="mb-3">
