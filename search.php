...
$getsearchquery = htmlentities($_GET['q']);
if(!$getsearchquery) {
          ...
          <div class="my-2 my-md-0 flex-grow-1 flex-md-grow-0 order-first order-md-last">
              <form action="api/search.php" method="POST">
                <div class="input-icon">
                  ...
                  <input id="search_query" name="search_query" type="text" class="form-control w-100" placeholder="Ara…" value="<?php echo $getsearchquery; ?>">
                </div>
              </form>
           </div>
            ...
            <div class="row g-4">
              <div class="col-9">
                <div class="row row-cards">
                    <?php
             		$sql = "SELECT * FROM contents WHERE name LIKE '%$getsearchquery%'";
             		$result = mysqli_query($conn, $sql);
             		while($row = mysqli_fetch_array($result)){
             		  $getcontentid = $row['contentid'];
             		  $getcontentthumbnail = $row['thumbnail'];
             		  $getcontentname = $row['name'];
                      $getcontenttype = $row['type'];
                      
                      if($getcontenttype == "doc") {
                      	$getcontenturl = "view_doc.php?docid=$getcontentid";
                      } else if($getcontenttype == "video") {
                      	$getcontenturl = "view_video.php?videoid=$getcontentid";
                      } else if($getcontenttype == "music") {
                      	$getcontenturl = "listen_music.php?musicid=$getcontentid";
                      }
                      
             		   echo "<div class=\"col-sm-6 col-lg-4\">
                <div class=\"card card-sm\">
                  <a href=\"$getcontenturl\" class=\"d-block\"><img src=\"assets/$getcontentthumbnail\" class=\"card-img-top\"></a>
                  <div class=\"card-body\">
