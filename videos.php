  ...
  <body>
    <div class="wrapper">
      ...
      <div class="page-wrapper">
        ...
        <div class="container-xl">
            <div id="videos" class="row row-cards">
            <script>
                $(document).ready(function () {
                    $.getJSON("./videos.json", 
                        ...
                        $.each(data, function (key, value) {
                            ...
                            student += '<a href="view_video.php?videoid='+value.videoid+'" class="d-block"><img src="assets/'+value.videothumbnail+'" class="card-img-top"></a>'
