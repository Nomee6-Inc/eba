...
$getuserlooklater = $dataquery['look_later'];
  ...
  if(isset($_POST['save_later'])) {
    ...
    header("Location: index.php?redir=videos.php");
}
?>
...
<html lang="tr">
  <head>
    ...
    <title>Videolar | Escort Buluşma Ağı</title>
    <!-- CSS files -->
    ...
    <div class="wrapper">
      ...
      <div class="page-wrapper">
        ...
        <div class="container-xl">
           ...
           <?php
             $sql = "SELECT * FROM contents WHERE type = 'video'";
               ...
               if(strstr($getuserlooklater, "$getcontentid")) {
                ...
                <div class=\"col-sm-6 col-lg-4\">
                	<div class=\"card card-sm\">
                    	<a href=\"view_video.php?videoid=$getcontentid\" class=\"d-block\"><img src=\"assets/$getcontentthumbnail\" class=\"card-img-top\"></a>
                        	<div class=\"card-body\">
