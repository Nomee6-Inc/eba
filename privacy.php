...
<html lang="tr">
  <head>
    ...
    <title>Gizlilik | Escort Buluşma Ağı</title>
    <!-- CSS files -->
          ...
          <div class="page-header d-print-none">
            <div class="row align-items-center">
              <div class="col">
	            ...
	            <div class="container-xl">
                  <h3 class="text-black">Gizlilik Politikamıza <a href="https://nomee6.xyz/privacy">https://nomee6.xyz/privacy</a> adresinden ulaşabilirsiniz.</h3>
                    <br>
                  <h2 class="text-green">İstatistik verileri:</h2>
                  	<iframe
                        style="border: 0; height: 200px; width: 600px;"
                        src="https://matomo.aliyasin.org/index.php?module=CoreAdminHome&action=optOut&language=tr&backgroundColor=&fontColor=&fontSize=18px&fontFamily="
                    ></iframe>
	            </div>
